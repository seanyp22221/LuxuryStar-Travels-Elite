...
<section
        x-show="{{$alphName}}"
         ...
         class="bg-gray-900 text-center justify-center  overflow-y-auto flex items-center z-50 inset-0 fixed">
    <div
        ...
        <div class="grid grid-cols-1 h-full gap-x-16 gap-y-8 lg:grid-cols-1">
            ...
            <div class="p-8 text-center bg-gray-800 rounded-lg shadow-lg h-full lg:p-12  lg:col-span-3">
                @if ($close)
    ...
    <style>
        ...
        ::-webkit-scrollbar {
            ...
            background: #364050; /* Optional: just make scrollbar invisible */
        }
