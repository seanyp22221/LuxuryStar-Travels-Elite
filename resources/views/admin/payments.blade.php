        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 p-4 gap-4">
                        ...
                        <table class="items-center w-full bg-transparent border-collapse">
                            ...
                            <tr class="text-gray-700 dark:text-gray-100">
                                ...
                                <td class="border-t-0 px-4 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4">
                                    <div>
                                        <a href="#"
                                           class="px-4 py-1 text-xs text-white dark:text-white rounded-lg bg-yellow-500">View</A>
                                    </div>
                                </td>
            ...
            <div
                ...
                <div class="rounded-t mb-0 px-0 border-0">
                    <div class="flex flex-wrap items-center px-4 py-2">
                        <div class="relative w-full max-w-full flex-grow flex-1">
                            <h3 class="font-semibold text-base text-gray-900 dark:text-gray-50">Recent Service
                                Bookings</h3>
                        </div>
                        <div class="relative w-full max-w-full flex-grow flex-1 text-right">
                            <button
                    ...
                    <div class="block w-full">
                        ...
                        <ul class="my-1">
                                    ...
                                    <div class="flex-grow flex justify-between items-center">
                                        <div class="self-center">
                                            <a class="font-medium text-gray-800 hover:text-gray-900 dark:text-gray-50 dark:hover:text-gray-100"
                                               href="#0" style="outline: none;">Sullavan Biersay</a> needs approval for
                                            a stop <a
                                                class="font-medium text-gray-800 dark:text-gray-50 dark:hover:text-gray-100"
                                                href="#0" style="outline: none;">At Rick's Cafe</a> in Negril
                                        </div>
                            ...
                            <li class="flex px-4">
                                ...
                                <!-- // End Icon for Notification -->
                                <div
                                    class="flex-grow flex items-center border-gray-100 dark:border-gray-400 text-sm text-gray-600 dark:text-gray-100 py-2">
                                    <div class="flex-grow flex justify-between items-center">
                                        <div class="self-center">
                                            <a class="font-medium text-gray-800 hover:text-gray-900 dark:text-gray-50 dark:hover:text-gray-100"
                                               href="#0" style="outline: none;">Sullavan Biersay</a> needs approval for
                ...
                <div class="w-full overflow-x-auto">
                    <table class="w-full">
                        ...
                        <tr class="bg-gray-50 dark:bg-gray-800 hover:bg-gray-100 dark:hover:bg-gray-900 text-gray-700 dark:text-gray-400">
                            ...
                            <td class="px-4 py-3 text-xs">
                                <span
                                    class="px-2 py-1 font-semibold leading-tight text-yellow-700 bg-yellow-300 rounded-full dark:bg-yellow-700 dark:text-yellow-300"> View </span>
                            </td>
                        </tr>
                        <tr class="bg-gray-50 dark:bg-gray-800 hover:bg-gray-100 dark:hover:bg-gray-900 text-gray-700 dark:text-gray-400">
                            <!-- Client -->
