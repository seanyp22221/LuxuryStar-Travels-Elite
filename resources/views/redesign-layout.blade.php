        ...
        >
            <div class="overflow-y-auto overflow-x-hidden flex flex-col justify-between flex-grow">
                <ul class="flex flex-col py-4 space-y-1">
                    ...
                    <!-- Entry Form -->
                    <li>
                        <a href="{{ route('admin-entryform-show')}}" class="relative flex flex-row items-center h-11 focus:outline-none hover:bg-yellow-600 text-white-600 duration-300 hover:text-white-800 border-l-4 border-transparent hover:border-gray-800 pr-6">
                                <span class="inline-flex justify-center items-center ml-4">
                                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
